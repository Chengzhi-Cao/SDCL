...
class iLIDSVID_dark_LIME(BaseVideoDataset):
    """
    iLIDS-VID
    ...
    def __init__(self, root='data', split_id=0, verbose=True, **kwargs):
        ...
        self.data_dir = osp.join(self.dataset_dir, 'i-LIDS-VID_dark_2_SCI')
        ...
        self.cam_1_path = osp.join(self.dataset_dir, 'i-LIDS-VID_dark2_LIME/sequences/cam1')
        self.cam_2_path = osp.join(self.dataset_dir, 'i-LIDS-VID_dark2_LIME/sequences/cam2')
