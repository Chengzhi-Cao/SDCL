...
class PRID_blur_event(object):
    ...
    img_cam_a_path = osp.join(root_img, 'prid_2011_blur29_30', 'multi_shot', 'cam_a')
    img_cam_b_path = osp.join(root_img, 'prid_2011_blur29_30', 'multi_shot', 'cam_b')
