...
class PRIDE_event_vid(object):
    ...
    root = '/gdata/caocz/Event_Re_ID/PRIDE'
    dataset_url = 'https://files.icg.tugraz.at/f/6ab7e8ce8f/?raw=1'
    split_path = osp.join(root, 'splits_pride.json')
    cam_a_path = osp.join(root, 'Event', 'cam_a')
    cam_b_path = osp.join(root, 'Event', 'cam_b')

    # root_img
    root_img = '/gdata/caocz/Event_Re_ID/PRIDE'
    dataset_url = 'https://files.icg.tugraz.at/f/6ab7e8ce8f/?raw=1'
    img_split_path = osp.join(root_img, 'splits_pride.json')
    img_cam_a_path = osp.join(root_img, 'Frame', 'cam_a')
    img_cam_b_path = osp.join(root_img, 'Frame', 'cam_b')
