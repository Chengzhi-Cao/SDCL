...
class Low_LIME(object):
    ...
    """
    root = '/gdata/caocz/Event_Re_ID/LowIllumination/LowIllumination_LIME'
    dataset_url = 'https://files.icg.tugraz.at/f/6ab7e8ce8f/?raw=1'
    split_path = osp.join(root, 'low.json')
    cam_a_path = osp.join(root, 'prid_2011', 'multi_shot', 'cam_a', 'cam_a')
    cam_b_path = osp.join(root, 'prid_2011', 'multi_shot', 'cam_b', 'cam_b')
