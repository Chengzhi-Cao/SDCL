...
class PRID_mat_img(object):
    ...
    """
    # root = '/gdata/caocz/Event_Re_ID/prid_2011/prid_event_divide'
    root = '/gdata/caocz/Event_Re_ID/prid_event_v2/prid_mat/prid'
    # gdata\caocz\Event_Re_ID\prid_event_v2\prid_mat\prid
    dataset_url = 'https://files.icg.tugraz.at/f/6ab7e8ce8f/?raw=1'
    split_path = osp.join(root, 'splits_prid2011.json')
    cam_a_path = osp.join(root, 'prid_mat_divide_img', 'multi_shot', 'cam_a')
    cam_b_path = osp.join(root, 'prid_mat_divide_img', 'multi_shot', 'cam_b')
