...
class iLIDSVID_event(BaseVideoDataset):
    """
    iLIDS-VID
    ...
    # cameras: 2
    """
    dataset_dir = '/gdata/caocz/Event_Re_ID/ilids-vid_sim'

    def __init__(self, root='data', split_id=0, verbose=True, **kwargs):
        # self.dataset_dir = osp.join(root, self.dataset_dir)
        self.dataset_dir = '/gdata/caocz/Event_Re_ID/ilids-vid_sim'
        self.dataset_url = 'http://www.eecs.qmul.ac.uk/~xiatian/iLIDS-VID/iLIDS-VID.tar'
        self.data_dir = osp.join(self.dataset_dir, 'i-LIDS-VID_mat_divide')
        ...
        self.cam_1_path = osp.join(self.dataset_dir, 'i-LIDS-VID_mat_divide/sequences/cam1')
        self.cam_2_path = osp.join(self.dataset_dir, 'i-LIDS-VID_mat_divide/sequences/cam2')
