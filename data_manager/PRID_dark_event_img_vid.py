...
class PRID_dark_event_img_vid(object):
    """
    PRID
    ...
    cam_a_path = osp.join(root, 'prid_event_divide_img2', 'multi_shot', 'cam_a')
    cam_b_path = osp.join(root, 'prid_event_divide_img2', 'multi_shot', 'cam_b')

    # root_img
    root_img = '/gdata/caocz/Event_Re_ID/prid_2011/prid_2011_dark'
    dataset_url = 'https://files.icg.tugraz.at/f/6ab7e8ce8f/?raw=1'
    ...
    def _process_data(self, dirnames, cam1=True, cam2=True):
        ...
        # print('img_tracklets=',img_tracklets[0][0][0])
        # print('tracklets=',tracklets[0][0][0])
        # sys.exit()
