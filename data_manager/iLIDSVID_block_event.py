...
class iLIDSVID_block_event(BaseVideoDataset):
    """
    iLIDS-VID
    ...
    def __init__(self, root='data', split_id=0, verbose=True, **kwargs):
        ...
        self.data_dir = osp.join(self.dataset_dir, 'i-LIDS-VID_block')
        ...
        self.cam_1_path = osp.join(self.dataset_dir, 'i-LIDS-VID_block/sequences/cam1')
        self.cam_2_path = osp.join(self.dataset_dir, 'i-LIDS-VID_block/sequences/cam2')
