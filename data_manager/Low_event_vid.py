...
class Low_event_vid(object):
    ...
    root = '/gdata/caocz/Event_Re_ID/LowIllumination/LowIllumination_ESIM_mat_divide'
    dataset_url = 'https://files.icg.tugraz.at/f/6ab7e8ce8f/?raw=1'
    split_path = osp.join(root, 'low.json')
    cam_a_path = osp.join(root, 'prid_2011',  'cam_a')
    cam_b_path = osp.join(root, 'prid_2011',  'cam_b')

    # root_img
    root_img = '/gdata/caocz/Event_Re_ID/LowIllumination/LowIllumination'
    dataset_url = 'https://files.icg.tugraz.at/f/6ab7e8ce8f/?raw=1'
    img_split_path = osp.join(root_img, 'low.json')
    img_cam_a_path = osp.join(root_img, 'prid_2011', 'multi_shot', 'cam_a','cam_a')
    img_cam_b_path = osp.join(root_img, 'prid_2011', 'multi_shot', 'cam_b','cam_b')
