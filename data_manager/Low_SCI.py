...
class Low_SCI(object):
    ...
    """
    root = '/gdata/caocz/Event_Re_ID/LowIllumination/LowIllumination'
    dataset_url = 'https://files.icg.tugraz.at/f/6ab7e8ce8f/?raw=1'
    split_path = osp.join(root, 'low.json')
    cam_a_path = osp.join(root, 'prid_2011_SCI', 'multi_shot', 'cam_a', 'cam_a')
    cam_b_path = osp.join(root, 'prid_2011_SCI', 'multi_shot', 'cam_b', 'cam_b')
    ...
    def _process_data(self, dirnames, cam1=True, cam2=True):
        ...
        #txt_name = 'prid' + str(cam1) + str(cam2) + '.txt'
        #fid = open(txt_name, "w")
