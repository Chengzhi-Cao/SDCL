...
class iLIDSVID_mat_img(BaseVideoDataset):
    """
    iLIDS-VID
    ...
    def __init__(self, root='data', split_id=0, verbose=True, **kwargs):
        ...
        self.cam_1_path = osp.join(self.dataset_dir, 'i-LIDS-VID_mat_divide/sequences_img/cam1')
        self.cam_2_path = osp.join(self.dataset_dir, 'i-LIDS-VID_mat_divide/sequences_img/cam2')
