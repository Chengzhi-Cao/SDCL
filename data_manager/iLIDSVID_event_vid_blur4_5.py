...
class iLIDSVID_event_vid_blur4_5(BaseVideoDataset):
    """
    iLIDS-VID
    ...
    def __init__(self, root='data', split_id=0, verbose=True, **kwargs):
        ...
        self.data_dir = osp.join(self.dataset_dir, 'i-LIDS-VID_blur_4_5')
        ...
        self.cam_1_path = osp.join(self.dataset_dir, 'i-LIDS-VID_blur_4_5/sequences/cam1')
        self.cam_2_path = osp.join(self.dataset_dir, 'i-LIDS-VID_blur_4_5/sequences/cam2')
